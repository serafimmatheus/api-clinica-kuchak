...
Revision ID: a9843268882b
Revises: 
Create Date: 2022-05-21 09:41:52.676711
...
def upgrade():
    ...
    sa.Column('pelagem', sa.String(length=50), nullable=False),
    sa.Column('is_castrado', sa.Boolean(), nullable=False),
    sa.Column('is_testado', sa.Boolean(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['pet_id'], ['dogs.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
